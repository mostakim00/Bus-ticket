...
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"Prince","Shyamoli Paribahan"," Hanif Enterprise","Royal Coach","Green Line","President"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
void cancle();
    ...
    system("CLS");
    printf("\t----------------------------------------------------------------------------------------------------------\n");
    printf("\t\t\t\t\tThank You For Being with Us,Stay Bless\t\t\t\t\t\t\n");
    printf("\t----------------------------------------------------------------------------------------------------------\n");
    getch();
    return 0;
}
    ...
    do
{
	...
	pword[i]='\0';
	i=0;
		if(strcmp(uname,"mostakim")==0 && strcmp(pword,"12345")==0)
	{
